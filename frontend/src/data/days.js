...
# every node/LLM call/token shows up at smith.langchain.com` },
    ...
    demos: [
      ...
      { id: 'm6_full',         section: 'modules', slide: 6, tab: 'M6 · Full run',      label: 'Module 6 · Full end-to-end capstone (interactive HITL)',          desc: 'Runs the SHARED research agent live and PAUSES at the approval gate — you click Approve or Request changes to drive the human-in-the-loop step.', needsQuestion: true  },
